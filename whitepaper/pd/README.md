...
| [Qwen3-32B Intel B60 Excel charts](./qwen3-32b-intel-b60-benchmark-charts.xlsx) | Editable source tables, comparison charts, heatmap, ABBA views, and dashboard for the main benchmark report |
